...
#creating a mask for sources and background of 1
mask = deepcopy(segmap2)
mask[np.where(mask == 2)] = 0
masked_data = mask * my_postage_data
...
plt.tight_layout()
plt.savefig('/Users/laurenhiggins/Desktop/499_Kam/Tutorial_VIII_Advanced_Image_Analysis/plots/segmap_source2.pdf', 
